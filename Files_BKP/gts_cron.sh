...
while true; do
	...
	show_message "1. Lister les taches cron"
    show_message "2. Ajouter une tache cron"
    show_message "3. Supprimer une tâche cron"
    show_message "4. Quitter"
	echo
    ...
    case $choix in
        ...
        2)
            ...
            show_message "Commandes disponibles :"
            show_message "1. Mettre en place le check space sur votre compte"
            show_message "2. Supprimer un fichier (ex. : nettoyer des anciens fichiers)"
			show_message "3. Personnaliser la Planification de tache"
			show_message "4. Retour au menu"
			echo
			...
			if [ "$commande" -ne 1 ] && [ "$commande" -ne 3 ]; then
				...
				show_message "1. Tous les jours à minuit"
				show_message "2. Tous les jours à 7h du matin"
				show_message "3. Tous les jours à midi"
				show_message "4. Tous les vendredis à 19h"
				show_message "5. Une fois par mois (1er du mois à minuit)"
				show_message "6. Une fois tous les deux mois (1er du mois impair à minuit)"
				show_message "7. Toutes les heures"
				show_message "8. Personnaliser la fréquence"
				show_message "9. Retour au menu"
				echo
